...
import { FormantHistory, FormantAnalyzer } from "../../formants-js";
...
export const render_timeslice = (formant_analyzer, formant_history, ctx, settings :GlobalConfiguration, offset : number = 0) => {
...
export const render_formant_bars = (_ : FormantAnalyzer, formant_history : FormantHistory, ctx : CanvasRenderingContext2D, settings : GlobalConfiguration, offset : number = 0) => {
